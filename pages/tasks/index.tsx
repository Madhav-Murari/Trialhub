    ...
    <>
      <div className="p-4 h-full">
        <div className="flex flex-row md:flex-col">
          <div className="bg-lighter-grey basis-1/2 flex flex-col md:flex-row items-center justify-between font-medium p-3 rounded-md">
            ...
            <div className="text-left w-full md:flex md:w-3/20">Task Assigned</div>
          ...
          <div className="bg-white basis-1/2 rounded-md shadow mx-1">
