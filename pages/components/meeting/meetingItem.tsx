    ...
    <>
      <tr className="h-10">
        ...
        <td className="items-center relative">
          <div className="w-14 h-10 mx-auto relative">
            {item?.invite?.[1] && (
              <img
                src={item.invite[1]}
                className="rounded-full w-10 h-10 border-2 border-white object-cover absolute left-0"
                alt="invited"
              />
            )}
            {item?.invite?.[0] && (
              <img
                src={item.invite[0]}
                className="rounded-full w-10 h-10 border-2 border-white object-cover absolute left-3"
                alt="invited"
              />
            )}
            <div className="bg-gray-300 w-10 h-10 flex justify-center items-center object-cover border-2 border-white rounded-full text-stone-600 text-[24px] absolute left-6">
              +
            </div>
          </div>
        </td>
        ...
        >
          ···
          {isClicked && (
            <div className="w-24 text-base bg-gray-100 z-10 absolute top-8 right-2">
